...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🎖️ channel 🎖️', url='https://t.me/ZEROX_MC')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💥 𝙾𝚆𝙽𝙴𝚁 💥', url='https://t.me/ZEROX_AS'), 
            InlineKeyboardButton('🎖️𝙲𝚑𝚊𝚗𝚗𝚎𝚕🎖️', url='https://t.me/ZEROX_MC')
            ],[      
        ...
        m=await message.reply_sticker("CAACAgUAAxkBAAIF0mKlYuNCqCWQT7haivRFasmgmabOAAInAQACyJRkFOI9YoCRRKaaHgQ") 
